...
progs='dialog whiptail lolcat figlet bc jc tmux gcc g++ 
				build-essential python3 git wget tree man-db tldr htop neovim'

[ "$choice" == '1' ] && sudo apt update && sudo apt -y upgrade &&
	sudo apt install -y $progs && sudo unminimize
